...
#error "A proper HID report type must be selected"
    ...
    /* Keep the DeskHop side-channel out of the keyboard collection so hosts do not
     * reinterpret the keyboard input report. Vendor-defined page 0xFF00, usage 0x01.
     */
    0x06, 0x00, 0xFF,
    0x09, 0x01,
    HID_COLLECTION(HID_COLLECTION_APPLICATION),
